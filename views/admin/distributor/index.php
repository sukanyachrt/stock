        ...
        <div class="content-wrapper">
            <div class="content-header">
                <div class="container-fluid">
                    <div class="row mb-2">
                        <div class="col-sm-6">
                            <h1 class="m-0">ข้อมูล Distributor</h1>
                        </div>
                                ...
                                <div class="card-body">
                                        ...
                                        <div class="form-group col-sm-12">
                                            <div class="input-group">
                                                ...
                                                <div class="input-group-append">
                                                    <button type="button" class="btn btn-primary" data-toggle="modal" data-target="#modal-distributor"><i class="fas fa-plus"></i>
                                                        เพิ่มข้อมูล</button>
                                                </div>
                                    ...
                                    <div class="row">
                                        <div class="col-12 table-responsive p-0">
                                            <table class="table table-bordered" id="tbdistributor">
                                                <thead>
                                                    <tr>
                                                        <th class="text-center" style="width: 200px">ชื่อ Distributor</th>
                    ...
                    <div class="modal-content">
                        <form id="distributorForm">
                            <div class="modal-header bg-primary">
                                <h4 class="modal-title">เพิ่มข้อมูล Distributor</h4>
                            ...
                            <div class="modal-body">
                                <div class="form-group">
                                    <label for="exampleInputEmail1">ชื่อ Distributor :</label>
                                    <input type="text" autocomplete="yes" class="form-control" id="nametype" name="nametype" placeholder="Distributor">
                                </div>
                            </div>
            ...
            <div class="modal fade" id="modal-edit">
                <div class="modal-dialog modal-md">
                    <div class="modal-content">
                        <form class="form-horizontal" id="editdistributorForm">
                            <div class="modal-header bg-warning">
                                <h4 class="modal-title">
                                    <i class="fa fa-edit"></i>
                                    แก้ไขข้อมูล Distributor
                                </h4>
                                <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                                    <span aria-hidden="true">&times;</span>
                                </button>
                                ...
                                <div class="row justify-content-center">
                                    <div class="col-12">
                                        <div class="input-group mb-3">
                                            ...
                                            <input type="text" autocomplete="yes" class="form-control" id="editnametype" name="editnametype" placeholder="ชื่อ Distributor">
                                        </div>
...
<script>
    ...
    $(function() {
        ...
        const table = new DataTable('#tbDistributor')
    ...
    function getdistributor() {
        ...
        $.ajax({
            ...
            success: function(response) {
                ...
                var table = $('#tbdistributor').DataTable();
                table.clear();
                var tbdistributor = '';
                $.each(response, function(index, item) {
                    tbdistributor += `<tr id="row_${item.id}">
                ...
                table.rows.add($(tbdistributor)).draw();
                table.draw();
    ...
    $('#editdistributorForm').validate({
        ...
        submitHandler: function(form) {
            ...
            $.ajax({
                type: 'POST',
                url: "services/distributor/data.php?v=updatedistributor",
                data: $(form).serialize(),
                success: function(response) {
                    console.log(response)
    ...
    function del() {
        var id = $('#delId').val();
        $.ajax({
            url: "services/distributor/data.php?v=deldistributor&id=" + id,
            success: function(response) {
                getdistributor();
